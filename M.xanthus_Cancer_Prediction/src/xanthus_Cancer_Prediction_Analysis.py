...
Description: 
This script processes predicted IC50 (inhibitory concentration) results for Myxococcus xanthus.
...
df = pd.read_csv('xanthus_anticancerpred.csv')
...
raw_df = pd.read_csv('xanthus_anticancerpred.csv', header=None)
...
df = pd.read_csv('xanthus_anticancerpred.csv', skiprows=1)
