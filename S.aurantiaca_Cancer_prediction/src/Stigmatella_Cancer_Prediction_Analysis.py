...
Description: 
This script processes predicted IC50 (inhibitory concentration) results for Stigmatella aurantiaca.
...
df = pd.read_csv('stigcancerpred.csv')
...
raw_df = pd.read_csv('stigcancerpred.csv', header=None)
...
df = pd.read_csv('stigcancerpred.csv', skiprows=1)
